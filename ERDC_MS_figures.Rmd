...
1. Flow for any given day is elevated: $$ strom flow = μ_{(previous 7 days)}+1⋅σ_{(previous 7 days)}$$
...
DMC_TSS_plot <- plot_dmc(
  ...
  flow_label = NULL,
  value_label = "Norm. TSS", #expression(Norm.~TSS~(mg~L^-1))
)
...
# ggsave(plot = flow_density_plt, filename = paste("/Users/kellyloria/Documents/DRI/ERDC_Davis_Fire/Figures/DMLC_flow_plot.png",sep=""),width=11,height=2, dpi=300)
